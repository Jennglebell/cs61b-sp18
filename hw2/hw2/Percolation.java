...
public class Percolation {
    ...
    // sites without bottom sites
    private WeightedQuickUnionUF sites2;
    // the virtual top site that connects all the sites at top
    private int topSite;
    // the virtual bottom site that connects all the sites at bottom
    ...
    public boolean isFull(int row, int col) {
        ...
        return sites.connected(topSite, xyTo1D(row, col));
    }
